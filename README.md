...
- BFM入門のヒーロー説明でサイトの目的を伝え、「お願い」は第1章の最後、制作背景はフッターの「このサイトについて」に配置しています。上部ナビゲーションから「BFM入門」「Offensive BFM」「Defensive BFM」の3系統へ移動できます
...
最上部のウェルカムとBFM入門の説明に続き、右上の「目次」と本文は次の18章で対応しています。最初に3つのPartで共通する学び方を確認してから、BFM入門へ進みます。
