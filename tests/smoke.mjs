...
async function run() {
  ...
  record(
    ...
    basics.componentArchitecture.componentStylesheet && basics.componentArchitecture.layeredStylesheets &&
      ...
      basics.componentArchitecture.scriptEntry && basics.componentArchitecture.scriptTags.length === 12,
  ...
  const noScript = await evaluate(socket, `(() => ({
    ...
    missionRevealPosition: getComputedStyle(document.querySelector(".mission-reveal-sticky")).position,
    nativeTocAvailable: Boolean(document.querySelector("#mission-index-menu > summary") &&
      document.querySelectorAll(".mission-index-list a").length === 18)
  }))()`);
  record(
    ...
    !noScript.initialized && noScript.moduleCount >= 15 && noScript.textLength > 10000 &&
      ...
      noScript.missionRevealPosition === "relative" && noScript.nativeTocAvailable,
